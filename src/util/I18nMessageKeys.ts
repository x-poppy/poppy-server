export enum I18nMessageKeys {
  ...
  App_Status_Is_Disabled = 'App_Status_Is_Disabled',
  App_Status_Is_Not_Normal = 'App_Status_Is_Not_Normal',
  App_Is_Expired = 'App_Is_Expired',

  // Role Entity
  Role_Is_Not_Exist = 'Role_Is_Not_Exist',
  Role_Status_Is_Disabled = 'Role_Status_Is_Disabled',
  Role_Status_Is_Not_Normal = 'Role_Status_Is_Not_Normal',

  // User Entity
  User_Is_Not_Exist = 'User_Is_Not_Exist',
  User_Status_Is_Disabled = 'User_Status_Is_Disabled',
  User_Status_Is_Locked = 'User_Status_Is_Locked',
  User_Status_Is_Not_Normal = 'User_Status_Is_Not_Normal',

  // CustomizedService Entity
  Customized_Service_Is_Not_Exist = 'Customized_Service_Is_Not_Exist',
  Customized_Service_Is_Disabled = 'Customized_Service_Is_Disabled',
  Customized_Service_Is_Not_Normal = 'Customized_Service_Is_Not_Normal',
  ...
  Login_User_Name_Or_Password_Is_InCorrect = 'Login_User_Name_Or_Password_Is_InCorrect',
  Login_Kick_User_Error = 'Login_Kick_User_Error',
